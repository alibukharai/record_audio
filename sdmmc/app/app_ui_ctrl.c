...
#define LABEL_WIFI_TEXT                 "请稍等，Wi-Fi 连接中\n"
#define LABEL_LISTENING_TEXT            "聆听中 ..."
#define LABEL_THINKING_TEXT             "思考中 ..."
...
static void show_panel_timer_handler(struct _lv_timer_t *t)
{
    ...
    case UI_CTRL_PANEL_LISTEN:
        ...
        lv_label_set_text(ui_LabelListenSpeak, LABEL_LISTENING_TEXT);
    ...
    case UI_CTRL_PANEL_GET:
        ...
        hide_panel[2] = ui_PanelReply;
        lv_obj_clear_flag(ui_LabelListenSpeak, LV_OBJ_FLAG_HIDDEN);
        lv_label_set_text(ui_LabelListenSpeak, LABEL_THINKING_TEXT);
        break;
